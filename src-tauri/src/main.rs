...
fn main() {
    ...
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            commands::external_reviews::list_external_identity_review_items,
            commands::external_reviews::submit_external_identity_review,
            commands::external_reviews::get_external_identity_review_history,
